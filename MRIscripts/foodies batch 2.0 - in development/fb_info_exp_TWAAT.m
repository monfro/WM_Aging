...
for s = 1:numel(subjects2do)
    all_subjects = [all_subjects,sprintf('pp%g',subjects2do(s))];
end
%all_subjects                = {'pp2'};
...
INFO.raw_data.filetypes.func.session_names       = {'TWAAT'};
...
INFO.dir.exp_root           = '/home/language/jooweg/FOCOM/experiments/TWAAT/data'; % root folder for the experiment containing subject subfolders
