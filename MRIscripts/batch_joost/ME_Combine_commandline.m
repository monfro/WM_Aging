function varargout = ME_Combine_commandline(sourcePath,targetPath,numberOfEchoes,WeightVolumes,prescanPath,numberOfRuns,smoothing,KernelSize)
% command line version of ME_Combine_GUI
% usage:
% ME_Combine_commandline(sourcePath,targetPath,numberOfEchoes,WeightVolumes,prescanPath,numberOfRuns,smoothing,KernelSize)
